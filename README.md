...
## Membros da Equipe:
- Artur Vinicius Couto de Oliveira
- Juliana Talita Silva
- Luana de Melo Queiroz
- Lucas da Silva Carvalho
- Walfrido Saturno do Nascimento
...
Aprendemos, ao longo do projeto, além de como programar em linguagem orientada a objeto, também como trabalhar em grupo, dividindo tarefas, comunicando e compartilhando ideias. A maior lição, pro grupo, foi a oportunidade de desenvolver um projeto em conjunto, em um ambiente em que todos estão aprendendo; não só em relação à programação, mas também realizar decisões em grupo.
